...
Three questions in wiki/active-work.md need exactly that data:
  ...
  - whether GSA_SUMMARY_TOKENS and GSA_CHARS_PER_TOKEN are calibrated
  - whether GSA_MAX_STEPS and GSA_TURN_TOKEN_BUDGET are near real usage
...
def open_trace(raw: str | None, session_root: Path) -> Trace:
    """Resolve GSA_TRACE. Unset writes to the session root; `off` disables it."""
